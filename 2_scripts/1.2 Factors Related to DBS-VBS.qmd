...
load(CLSA_mncom, file = '~/dbs-vs-venous-antibodies/1_data/private/CLSA_mncom.RData')

# Comprehensive cohort, traveling dist < 50
...
#### PCR, Hosp, Vaccination and additonal factors
```{r}
CLSA_com50<-merge(CLSA_com50, select(CLSA_Time, entity_id, time_vac, time_vac15), by='entity_id',
      all.x = T, all.y = F)

table(CLSA_com50$time_vac15, CLSA_com50$SER_ADM_COV)
```
