...
## We decided to add the DBS_adjusted into the figure
...
plot(stats::ecdf(CLSAs$s_dbs_adj[CLSAs$SER_ADM_COV==0 & 
                                 CLSAs$SER_SPIKE_COV==1]),
     add = TRUE,
     lwd=2,
     lty = "dashed",
...
legend("bottomright", legend = c("DBS", "DBS_adjusted", "Venous"),
       lwd = 3, col = c("blue", "brown", "red"))
dev.off()
```


#### K.S test (preferred) and t-test comparing DBS_adj and venous

```{r}
# K.S test showed sig diff bw adjusted DBS (brown) and venous
ks.test(CLSAs$SPIKE_ANTIBODY[CLSAs$SER_ADM_COV==1 & 
                             CLSAs$SER_SPIKE_COV==1],
        CLSAs$s_dbs_adj[CLSAs$SER_ADM_COV==0 & 
                        CLSAs$SER_SPIKE_COV==1],
        alternative = "two.sided")

# remove those beyond range of detection (>1600 & <0):
ks.test(CLSAs$SPIKE_ANTIBODY[CLSAs$SER_ADM_COV==1 & 
                             CLSAs$SER_SPIKE_COV==1 &
                             CLSAs$SPIKE_ANTIBODY<2500],
        CLSAs$s_dbs_adj[CLSAs$SER_ADM_COV==0 & 
                        CLSAs$SER_SPIKE_COV==1 &
                        CLSAs$s_dbs_adj<2500 &
                        CLSAs$s_dbs_adj>0],
        alternative = "two.sided")
# After removing the out-of-range values (>2500, <0), the distribution of DBS_adj and venous is not significant different (P=0.1661). 

# This is unweighhted K.S test, should do weighted K.S test using ks_test() in {Ecume} pak.

# student t-test for log10 transformed:
var.test(log10(CLSAs$SPIKE_ANTIBODY[CLSAs$SER_ADM_COV==1 & 
                             CLSAs$SER_SPIKE_COV==1]),
         log10(CLSAs$s_dbs_adj[CLSAs$SER_ADM_COV==0 & 
                        CLSAs$SER_SPIKE_COV==1])
        ) #var equal = T

 t.test(log10(CLSAs$SPIKE_ANTIBODY[CLSAs$SER_ADM_COV==1 & 
                             CLSAs$SER_SPIKE_COV==1]),
        log10(CLSAs$s_dbs_adj[CLSAs$SER_ADM_COV==0 & 
                        CLSAs$SER_SPIKE_COV==1]),
        alternative = "two.sided", var.equal = TRUE)
 
# student t-test, but remove out-of-range values
 t.test(log10(CLSAs$SPIKE_ANTIBODY[CLSAs$SER_ADM_COV==1 & 
                                   CLSAs$SER_SPIKE_COV==1 &
                                   CLSAs$SPIKE_ANTIBODY<2500]),
        log10(CLSAs$s_dbs_adj[CLSAs$SER_ADM_COV==0 & 
