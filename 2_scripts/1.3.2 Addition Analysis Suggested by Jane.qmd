...
CLSA_com50.c6<-CLSA_com50 %>%
  dplyr::select(SER_ADM_COV, AGE_NMBR_COVID , age10, SEX_CLSA ,
            ...
            SER_EDU_COV ,
            DEP_CESD10_COVX ,
            dist_min , dist_min_km,
            time_vac15,
            PROV_5, outbreak, avgincidence_last7,
            SER_NUCLEOCAPSID_COV, SER_SPIKE_COV, SPIKE_ANTIBODY)
CLSA_com50.c6$DEP_CESD10_COVX[CLSA_com50.c6$DEP_CESD10_COVX==-88881]<-NA
table(CLSA_com50.c6$DEP_CESD10_COVX, useNA = 'ifany') #-88881 recoded as NA
...
## At the end of the figure, add ORs for Anti-N and Anti-S. Those numbers come from the weighted analysis, instead of the unweighted logistic regression models
