...
```{r}
# Labels
label(CLSA_com50$AGE_NMBR_COVID)="Age"
label(CLSA_com50$SEX_CLSA)="Sex"
label(CLSA_com50$URBAN_RURAL_COVID)="Urban/Rural"
label(CLSA_com50$SER_EDU_COV)="Education"
label(CLSA_com50$SER_ETHN_WH_COV)="Race Binary"
label(CLSA_com50$DEP_CESD10_COVX)="Dep Scale"
label(CLSA_com50$dist_min)='Travel Dist'
label(CLSA_com50$time_vac15)='Vax over 15 Days'
label(CLSA_com50$outbreak)="Outbreak Peaks"
label(CLSA_com50$PROV_5)="Prov Group"
```
